...
namespace UnityEngine.AddressableAssets
{
    internal class AddressablesImpl : IEqualityComparer<IResourceLocation>
    {
        ...
        internal const string kCacheDataFolder = "{UnityEngine.AddressableAssets.AddressablesPortablePaths.CacheDataFolder}/com.unity.addressables/";
...
#if !UNITY_SWITCH
            // MateEngine portable build: reading Unity's default persistent path creates a LocalLow product directory on Windows.
            GC.KeepAlive(AddressablesPortablePaths.CacheDataFolder);
#endif
